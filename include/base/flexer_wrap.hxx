...
public:
	...
	m_fnRegisterCallback = (COMX_LEXER_RegisterCallback_t)dlsym(m_hInstLib, "COMX_LEXER_RegisterCallback");
        assert(m_fnRegisterCallback != NULL);

        m_fnFlexEntryEx = (COMX_LEXER_FlexEntryEx_t)dlsym(m_hInstLib, "COMX_LEXER_FlexEntryEx");
        m_fnRegisterReplaceCallback = (COMX_LEXER_RegisterReplaceCallback_t)dlsym(m_hInstLib, "COMX_LEXER_RegisterReplaceCallback");
#endif
    }
    ~TComxFlexer()
    {
